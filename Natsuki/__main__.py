...
PM_START_TEXT = """
Hello I'm ANSI ❤️,
༒︎ I ᴀᴍ ᴍᴜʟᴛɪ ᴛᴀʟᴇɴᴛᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ᴏsᴍ ғᴇᴀᴛᴜʀᴇs[.](https://telegra.ph/file/44b8559aadbccac927cf3.jpg)
➪ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴀᴅᴍɪɴ ᴛᴏ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴇxᴘʟᴏsɪᴠᴇ.
➪ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ᴍᴀsᴛᴇʀ](t.me/its_pandit_boy) ғᴏʀ ᴀɴʏ ǫᴜᴇʀʏ ᴀɴᴅ [Chat group😊](https://t.me/global_chatting_zone) ʜᴇʀᴇ
...
buttons = [
    [
        InlineKeyboardButton(
            text="Bot update 😍", url="https://t.me/our_powerfull_bots"
        ),
        InlineKeyboardButton(
            text="Join us grp😂", url="https://t.me/global_chatting_zone"
        ),
    ],
    [
        InlineKeyboardButton(
            text="Ansi👈 ka hubby😂", url="t.me/its_pandit_Andy"
        ),
        InlineKeyboardButton(
    ...
    [
        InlineKeyboardButton(
            text="❤️ Add To ANSI  inYour Group ❤️",
            url="t.me/ansi_Ro_bot?startgroup=true",
        ),
    ],
]

NATSUKI_IMG = "https://telegra.ph/file/a73fe131bf09ec7ae694b.jpg"

HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/44b8559aadbccac927cf3.jpg)
...
Support them  [PANDIT ANDY](t.me/its_pandit_Andy)"""
...
def Natsuki_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by Ansi👈 ka hubby😂 Updates.* "
            f"\n\n Join [Join us grp😂](https://t.me/global_chatting_zone) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Join us grp😂](https://t.me/global_chatting_zone).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [Ansi👈 ka hubby😂](t.me/its_pandit_Andy)."
